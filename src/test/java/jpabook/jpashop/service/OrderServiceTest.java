...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        int price = 10000;
        int stock = 10;
        Book book = createBook(price, stock);
        ...
        assertEquals("주문 수량만큼 재고가 줄어야한다.", stock - orderCount, book.getStockQuantity());
    }
    ...
    public void 주문취소() throws Exception {
        ...
        int price = 10000;
        int stock = 10;
        Book item = createBook(price, stock);
        ...
        assertEquals("주문이 취소된 상품은 그만큼 재고가 증가해야한다.", stock, item.getStockQuantity());
    }
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        int price = 10000;
        int stock = 10;
        Item item = createBook(price, stock);
    ...
    private Book createBook(int price, int stock) {
        Book book = new Book();
        book.setName("시골 JPA");
        book.setPrice(price);
